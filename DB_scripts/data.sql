...
insert into users (id, first_name, last_name, email, password, province, location, birthdate, gender, image, alt, admin, register_date) values (DEFAULT, 'Marline', 'Van Halen', 'user_default@middo.com', '$2a$10$hyrC6XmMRkSmgZRrc.fSgerwFZ2XdHobxe5t/twpbpGJDpvczbj3u', 'Nicaragua', 'Boaco', '3/26/1997', 'female', 'prof-img-photo-1597799103501-8a421a387cc5.jpg', null, false, '5/28/2020');
